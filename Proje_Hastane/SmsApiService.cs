...
namespace Proje_Hastane
{
    class SmsApiService
    {
        ...
        public void SmsSender(string TelNo, string SmsText)
        {
            ...
            testXml += "<username>Serkan Çakır</username>";// ileti merkezi kullanııc adınız
            testXml += "<password>Firdevs4</password>";// ileti merkezi kullanıcı şifreniz
            testXml += "</authentication>";
            testXml += "<order>";
            testXml += "<sender>Deneme</sender>";// Size ait olan sms başlığınız
